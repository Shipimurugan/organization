...
SECRET_KEY = 'django-insecure-3y7&^hp080#!j&)(vs0)(%9y^^5zln7%l^ie%nulf%hao-1*s5'
...
TOKEN_SECRET_KEY = 'dj6XwGMRppl-krCl9FYRuQ8eefec7nohhXAchlw0zM0='.encode()
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': (
        'authentication.jwt_authentication.IsAuthenticated',  
    ),
}
